...
public class OldButtonMovement : MonoBehaviour
{
    ...
    void Start()
    {
        pickupManager = GameObject.Find("Main Camera").GetComponent<OldPickupScript>();
